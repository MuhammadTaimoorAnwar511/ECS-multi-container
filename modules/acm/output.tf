output "certificate_arn" {
  description = "ARN of the ACM certificate (either created or detected)"
  value       = var.create_acm ? try(aws_acm_certificate.this[0].arn, null) : try(data.aws_acm_certificate.existing[0].arn, null)
}
